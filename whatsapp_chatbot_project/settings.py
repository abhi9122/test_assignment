"""
Django settings for whatsapp_chatbot_project project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'test-assignment-ofpl.onrender.com']
...
WSGI_APPLICATION = "whatsapp_chatbot_project.wsgi.application"
