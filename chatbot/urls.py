...
from .views import UserSignupView, UserLoginView, MessageCreateView, MessageRetrieveView, ChatbotCreateView, ChatbotRetrieveView, QuestionsCreateView, QuestionsListView, TwilioWebhookView

urlpatterns = [
    path('signup/', UserSignupView.as_view(), name='user-signup'),
    path('login/', UserLoginView.as_view(), name='user-login'),
    path('messages/', MessageCreateView.as_view(), name='message-create'),
    path('messages/<uuid:pk>/', MessageRetrieveView.as_view(), name='message-detail'),
